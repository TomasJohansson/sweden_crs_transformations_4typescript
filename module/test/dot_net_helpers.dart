// This TypeScript project have been ported from C#.NET and Dart, 
...
// use the TypeScript 'expect' function instead, but to keep the traceability i.e. 
...
export default class Assert {
  ...
  static IsTrue(actual: boolean): void {
    expect(actual).toEqual(true);
  }  
  static IsFalse(actual: boolean): void {
